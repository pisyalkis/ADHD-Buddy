...
PROBLEM_ITEMS = [
    ("bedstuck",    "🛏 Трудно начать день, подолгу лежу в кровати"),
    ("notasks",     "🗂️ Не могу решить, какие задачи ставить"),
    ("nostructure", "🧭 Непонятно, как построить день целиком"),
...
PROBLEM_HELP_TEXT = {
    ...
    "notasks":     "🗂️ *Не могу решить, какие задачи ставить* — утром помогу выбрать всего одну главную задачу и до двух важных — не весь список дел, а только то, что реально нужно сегодня.",
    "nostructure": "🧭 *Непонятно, как построить день* — задаю простую структуру: одна главная задача, пара важных, остальное по желанию — и напоминаю в течение дня, что сейчас актуально.",
