...
SKILLS = [
    {
        ...
        "explanation": "Нет такого дела, которое ты не мог(ла) бы забыть. Список дел разгружает оперативную память мозга.",
        "instructions": "Как только появилась задача — сразу запиши, не пытайся удержать в голове. Календарь — для встреч с конкретным временем. Список дел — для всего остального."
    },
    {
        "name": "🔤 Приоритеты A, B, C",
        "desc": "1 задача A (обязательно), 2 задачи B (желательно), 3 задачи C (по возможности).",
        "explanation": "Мозг с СДВГ любит брать лёгкое первым — это ловушка.",
        "instructions": "Сначала A, потом B, потом C. Сделай A даже если хочется пропустить. Если сделал(а) только A — день прожит не зря."
    },
    {
        "name": "🛑 Навык СТОП",
        ...
        "instructions": "С-Стой. Т-Только шаг назад. О-Осмотрись. П-Попытайся действовать осознанно. Используй когда: отвлёкся(ась), застрял(а), чувствуешь импульс сделать что-то необдуманное, или просто залип(ла) в телефоне."
    },
    {
    ...
    },
    {
        ...
        "explanation": "Мотивация не придёт сама. Сначала действие — потом мотивация.",
    ...
    },
    {
        ...
        "instructions": "Перерывы 5-10 минут каждые 25-30 минут. Составь список отдыха заранее, чтобы не было паралича выбора."
    },
    {
        "name": "⚓ Бросить якорь",
    ...
    },
    {
        ...
        "explanation": "Это профилактирует гиперфокус и истощение.",
    ...
    },
    {
        ...
        "instructions": "Когда работаешь и приходит отвлекающая мысль — запиши её, скажи себе 'займусь позже' и вернись к задаче. В конце дня реши: это правда важно, или просто казалось привлекательным?"
    },
    {
        "name": "💧 Холодная вода",
    ...
    },
    {
        ...
        "explanation": "Среда влияет на фокус сильнее, чем сила воли.",
    ...
    },
    {
        ...
        "instructions": "Почувствуй опору под ногами. Расслабь лицо от лба вниз. Мягко приподними уголки губ — это улыбка себе, не на камеру. Ладони вверх. Приступи к задаче. Когда заметишь сопротивление — повтори."
    },
]
