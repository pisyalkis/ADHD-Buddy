...
SKILLS = [
    ...
    {
        "name": "⚓ Бросить якорь",
        "desc": "Помогает удержаться, когда захлестнули эмоции — тревога, паника, злость.",
