...
SKILLS = [
    {
        ...
        "instructions": "Веди один большой список — туда попадает вообще всё: срочное и не очень, крупное и мелкое, даже то, что пригодится через месяц. Из этого списка каждый день ты выбираешь несколько дел и превращаешь их в свои A/B/C задачи на сегодня. Календарь — только для встреч с конкретным временем, всё остальное — в список.\n\n_Сейчас в боте нет отдельного общего списка — задачи A/B/C вписываются заново каждое утро. Если хочешь держать длинный список «на будущее», веди его отдельно (заметки, другое приложение), а сюда каждый день переноси то, что приоритетно именно сегодня._"
    },
    {
